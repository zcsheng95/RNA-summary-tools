...
anno <- read.table(file.path(annodir, "annotation.txt"),header = TRUE,sep ='\t')
rnaqc <- RNAqc(counts = starcounts, colData = coldata, picard = picounts,anno = NULL)
show(rnaqc)
```
...
idlist = c('gene1.1','gene2.1','gene3.1','gene4.1')
checkExpression(rnaqc, group = "condition", target = idlist,gridvar = "genotype")
```
